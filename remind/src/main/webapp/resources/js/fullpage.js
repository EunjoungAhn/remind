function fullset(){
	...
	for(var i=1; i <= pageindex; i++){
		$("#fullpage > .quick > ul").append("<li></li>"); //우측 스크롤 네비게이션 표시
	}
	...
	$(window).bind("mousewheel", function(event){
		...
		console.log("현재 on 되어있는 페이지 번호:",page.index()+1);  // 현재 on 되어있는 페이지 번호
		if($("container").find("#fullpage:animated").length >= 1) return false;
		//마우스 휠을 위로
